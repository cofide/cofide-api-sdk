...
const (
	ClusterService_CreateCluster_FullMethodName  = "/proto.connect.cluster_service.v1alpha1.ClusterService/CreateCluster"
	ClusterService_DestroyCluster_FullMethodName = "/proto.connect.cluster_service.v1alpha1.ClusterService/DestroyCluster"
	ClusterService_GetCluster_FullMethodName     = "/proto.connect.cluster_service.v1alpha1.ClusterService/GetCluster"
	ClusterService_ListClusters_FullMethodName   = "/proto.connect.cluster_service.v1alpha1.ClusterService/ListClusters"
	ClusterService_UpdateCluster_FullMethodName  = "/proto.connect.cluster_service.v1alpha1.ClusterService/UpdateCluster"
)
...
func (c *clusterServiceClient) DestroyCluster(ctx context.Context, in *DestroyClusterRequest, opts ...grpc.CallOption) (*DestroyClusterResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DestroyClusterResponse)
	err := c.cc.Invoke(ctx, ClusterService_DestroyCluster_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedClusterServiceServer) DestroyCluster(context.Context, *DestroyClusterRequest) (*DestroyClusterResponse, error) {
...
func _ClusterService_DestroyCluster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DestroyClusterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClusterServiceServer).DestroyCluster(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ClusterService_DestroyCluster_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClusterServiceServer).DestroyCluster(ctx, req.(*DestroyClusterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ClusterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.connect.cluster_service.v1alpha1.ClusterService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ClusterService_DestroyCluster_Handler,
		},
		{
	...
	Metadata: "proto/connect/cluster_service/v1alpha1/cluster_service.proto",
}
