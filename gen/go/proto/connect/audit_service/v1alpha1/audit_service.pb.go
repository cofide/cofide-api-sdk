...
type RecordExchangeRequest struct {
	...
	// Outbound identity set on the exchanged token. Only set when outcome = OUTCOME_SUCCESS.
	OutboundIdentity string `protobuf:"bytes,12,opt,name=outbound_identity,json=outboundIdentity,proto3" json:"outbound_identity,omitempty"`
	// Outbound scopes granted on the exchanged token. Only set when outcome = OUTCOME_SUCCESS.
	OutboundScopes []string `protobuf:"bytes,13,rep,name=outbound_scopes,json=outboundScopes,proto3" json:"outbound_scopes,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *RecordExchangeRequest) GetOutboundIdentity() string {
	if x != nil {
...
func (x *RecordExchangeRequest) GetOutboundScopes() []string {
	if x != nil {
...
var file_proto_connect_audit_service_v1alpha1_audit_service_proto_rawDesc = string([]byte{
	...
	0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x9a, 0x05, 0x0a, 0x15,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x70, 0x12, 0x30, 0x0a, 0x11, 0x6f, 0x75, 0x74, 0x62,
	0x6f, 0x75, 0x6e, 0x64, 0x5f, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x0c, 0x20,
	0x01, 0x28, 0x09, 0x42, 0x03, 0xe0, 0x41, 0x01, 0x52, 0x10, 0x6f, 0x75, 0x74, 0x62, 0x6f, 0x75,
	0x6e, 0x64, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x2c, 0x0a, 0x0f, 0x6f, 0x75,
	0x74, 0x62, 0x6f, 0x75, 0x6e, 0x64, 0x5f, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x73, 0x18, 0x0d, 0x20,
	0x03, 0x28, 0x09, 0x42, 0x03, 0xe0, 0x41, 0x01, 0x52, 0x0e, 0x6f, 0x75, 0x74, 0x62, 0x6f, 0x75,
	0x6e, 0x64, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x73, 0x22, 0x18, 0x0a, 0x16, 0x52, 0x65, 0x63, 0x6f,
