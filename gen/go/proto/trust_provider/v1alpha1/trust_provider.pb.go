...
func file_proto_trust_provider_v1alpha1_trust_provider_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_trust_provider_v1alpha1_trust_provider_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_proto_trust_provider_v1alpha1_trust_provider_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
