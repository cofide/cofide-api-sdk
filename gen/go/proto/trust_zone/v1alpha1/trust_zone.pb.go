...
type TrustZone struct {
	...
	Federations           []*v1alpha1.Federation `protobuf:"bytes,8,rep,name=federations,proto3" json:"federations,omitempty"`
	AttestationPolicies   []*v1alpha11.APBinding `protobuf:"bytes,9,rep,name=attestation_policies,json=attestationPolicies,proto3" json:"attestation_policies,omitempty"`
	...
	Clusters              []*v1alpha12.Cluster   `protobuf:"bytes,13,rep,name=clusters,proto3" json:"clusters,omitempty"`
}
...
var file_proto_trust_zone_v1alpha1_trust_zone_proto_rawDesc = []byte{
	...
	0x6c, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x11, 0x62, 0x75, 0x6e, 0x64, 0x6c,
	...
	0x70, 0x6f, 0x69, 0x6e, 0x74, 0x5f, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x18, 0x0c, 0x20,
	...
	0x01, 0x12, 0x3b, 0x0a, 0x08, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x73, 0x18, 0x0d, 0x20,
