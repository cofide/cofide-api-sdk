...
var file_proto_ap_binding_v1alpha1_ap_binding_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x2f, 0x61, 0x70, 0x5f, 0x62, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x2f, 0x76,
...
func file_proto_ap_binding_v1alpha1_ap_binding_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_ap_binding_v1alpha1_ap_binding_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*APBinding); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
