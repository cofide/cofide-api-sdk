...
import (
	...
	context "context"
	errors "errors"
	v1alpha2 "github.com/cofide/cofide-api-sdk/gen/go/proto/provision_plugin/v1alpha2"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ProvisionPluginServiceName = "proto.provision_plugin.v1alpha2.ProvisionPluginService"
)
...
const (
	...
	ProvisionPluginServiceValidateProcedure = "/proto.provision_plugin.v1alpha2.ProvisionPluginService/Validate"
	// ProvisionPluginServiceDeployProcedure is the fully-qualified name of the ProvisionPluginService's
	// Deploy RPC.
	ProvisionPluginServiceDeployProcedure = "/proto.provision_plugin.v1alpha2.ProvisionPluginService/Deploy"
	// ProvisionPluginServiceTearDownProcedure is the fully-qualified name of the
	// ProvisionPluginService's TearDown RPC.
	ProvisionPluginServiceTearDownProcedure = "/proto.provision_plugin.v1alpha2.ProvisionPluginService/TearDown"
	...
	ProvisionPluginServiceGetHelmValuesProcedure = "/proto.provision_plugin.v1alpha2.ProvisionPluginService/GetHelmValues"
)

// ProvisionPluginServiceClient is a client for the
// proto.provision_plugin.v1alpha2.ProvisionPluginService service.
...
// proto.provision_plugin.v1alpha2.ProvisionPluginService service. By default, it uses the Connect
...
func NewProvisionPluginServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProvisionPluginServiceClient {
	...
	provisionPluginServiceMethods := v1alpha2.File_proto_provision_plugin_v1alpha1_plugin_proto.Services().ByName("ProvisionPluginService").Methods()
...
// Validate calls proto.provision_plugin.v1alpha2.ProvisionPluginService.Validate.
...
// Deploy calls proto.provision_plugin.v1alpha2.ProvisionPluginService.Deploy.
...
// TearDown calls proto.provision_plugin.v1alpha2.ProvisionPluginService.TearDown.
...
// GetHelmValues calls proto.provision_plugin.v1alpha2.ProvisionPluginService.GetHelmValues.
...
func NewProvisionPluginServiceHandler(svc ProvisionPluginServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/proto.provision_plugin.v1alpha2.ProvisionPluginService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProvisionPluginServiceHandler) Validate(context.Context, *connect.Request[v1alpha2.ValidateRequest]) (*connect.Response[v1alpha2.ValidateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.provision_plugin.v1alpha2.ProvisionPluginService.Validate is not implemented"))
}
...
func (UnimplementedProvisionPluginServiceHandler) Deploy(context.Context, *connect.Request[v1alpha2.DeployRequest], *connect.ServerStream[v1alpha2.DeployResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("proto.provision_plugin.v1alpha2.ProvisionPluginService.Deploy is not implemented"))
}
...
func (UnimplementedProvisionPluginServiceHandler) TearDown(context.Context, *connect.Request[v1alpha2.TearDownRequest], *connect.ServerStream[v1alpha2.TearDownResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("proto.provision_plugin.v1alpha2.ProvisionPluginService.TearDown is not implemented"))
}
...
func (UnimplementedProvisionPluginServiceHandler) GetHelmValues(context.Context, *connect.Request[v1alpha2.GetHelmValuesRequest]) (*connect.Response[v1alpha2.GetHelmValuesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.provision_plugin.v1alpha2.ProvisionPluginService.GetHelmValues is not implemented"))
}
