...
type FederatedService struct {
	...
	// SPIFFE ID paths of the application(s) referenced by this Federated Service
	// Consumers should cleanly handle presence/absence of a leading slash
	SpiffeIdPaths []string `protobuf:"bytes,15,rep,name=spiffe_id_paths,json=spiffeIdPaths,proto3" json:"spiffe_id_paths,omitempty"`
...
func (x *FederatedService) GetSpiffeIdPaths() []string {
	if x != nil {
		return x.SpiffeIdPaths
	}
	return nil
}
...
var file_proto_federated_service_v1alpha1_federated_service_proto_rawDesc = string([]byte{
	...
	0x41, 0x74, 0x12, 0x2b, 0x0a, 0x0f, 0x73, 0x70, 0x69, 0x66, 0x66, 0x65, 0x5f, 0x69, 0x64, 0x5f,
	0x70, 0x61, 0x74, 0x68, 0x73, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x09, 0x42, 0x03, 0xe0, 0x41, 0x02,
	0x52, 0x0d, 0x73, 0x70, 0x69, 0x66, 0x66, 0x65, 0x49, 0x64, 0x50, 0x61, 0x74, 0x68, 0x73, 0x1a,
	...
	0x01, 0x28, 0x05, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x2a, 0x4f, 0x0a, 0x07, 0x54, 0x4c, 0x53,
	...
	0x54, 0x49, 0x4f, 0x5f, 0x4d, 0x54, 0x4c, 0x53, 0x10, 0x02, 0x42, 0x4a, 0x5a, 0x48, 0x67, 0x69,
	...
	0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x66, 0x65, 0x64, 0x65,
	0x72, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x76, 0x31,
...
var file_proto_federated_service_v1alpha1_federated_service_proto_depIdxs = []int32{
	...
	5, // 4: proto.federated_service.v1alpha1.FederatedService.created_at:type_name -> google.protobuf.Timestamp
	5, // 5: proto.federated_service.v1alpha1.FederatedService.last_updated_at:type_name -> google.protobuf.Timestamp
