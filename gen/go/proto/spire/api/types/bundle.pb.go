...
var file_proto_spire_api_types_bundle_proto_rawDesc = []byte{
...
var (
	...
	file_proto_spire_api_types_bundle_proto_rawDescData = file_proto_spire_api_types_bundle_proto_rawDesc
)

func file_proto_spire_api_types_bundle_proto_rawDescGZIP() []byte {
	file_proto_spire_api_types_bundle_proto_rawDescOnce.Do(func() {
		file_proto_spire_api_types_bundle_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_spire_api_types_bundle_proto_rawDescData)
	})
...
func file_proto_spire_api_types_bundle_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_spire_api_types_bundle_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Bundle); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_spire_api_types_bundle_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_proto_spire_api_types_bundle_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*JWTKey); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_spire_api_types_bundle_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_spire_api_types_bundle_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_proto_spire_api_types_bundle_proto_rawDesc = nil
