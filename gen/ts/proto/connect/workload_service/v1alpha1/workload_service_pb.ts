...
export type ListWorkloadEventsRequest_Filter = Message<"proto.connect.workload_service.v1alpha1.ListWorkloadEventsRequest.Filter"> & {
  ...
  /**
   * @generated from field: string workload_id = 10;
   */
  workloadId: string;
};
