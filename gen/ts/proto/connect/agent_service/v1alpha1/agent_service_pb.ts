...
export const AgentService: GenService<{
  /**
   * CreateAgentJoinToken generates a one-time token that a Cofide Agent uses
   * to join a specific trust zone and cluster.
   *
  ...
  /**
   * UpdateAgentStatus reports the current operational status of a Cofide Agent
  ...
  /**
   * RegisterFederatedService registers a federated service discovered by the
   * agent, making it available for cross-zone connectivity.
   *
  ...
  /**
   * DeregisterFederatedService removes a previously registered federated service.
   *
  ...
  /**
   * UpdateFederatedService updates the configuration of a registered federated service.
   *
  ...
  /**
   * ListFederatedServices lists all federated services for an organization.
   *
